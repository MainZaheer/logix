    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 d-flex justify-content-end">
                <h3><a href="{{ route('otherCharges.create') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>
                        Other Charges</a></h3>
            </div>
        </div>
    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="dataTables_wrapper dt-bootstrap4">
                            <table id="other_charges_table" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                             <th>Name</th>
                                              <th>Status</th>
...
@if(session('success'))
    ...
    @endif
        ...
        $(document).ready(function () {
            $('#other_charges_table').DataTable({
               "autoWidth": false,
                processing: true,
                serverSide: true,
                ajax: "{{ route('otherCharges.index') }}",
                columns: [
                    { data: 'name', name: 'name' },
