    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 d-flex justify-content-end">
                <h3><a href="{{ route('gatepasses.create') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>
                        Add GatePass</a></h3>
            </div>
        </div>
    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="dataTables_wrapper dt-bootstrap4">
                            <table id="gate_pass_table" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                             <th>Name</th>
                                              <th>Status</th>
...
@if(session('success'))
    ...
    @endif
        ...
        $(document).ready(function () {
            $('#gate_pass_table').DataTable({
               "autoWidth": false,
                processing: true,
                serverSide: true,
                ajax: "{{ route('gatepasses.index') }}",
                columns: [
                    { data: 'name', name: 'name' },
